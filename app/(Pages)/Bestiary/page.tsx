...
import bestiary_bg_3 from "@/app/assets/images/bestiary_bg_3.jpg";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col md:-mt-14">
      <section className="md:-mt-14 w-full h-auto">
        <Image className="w-full h-auto" src={bestiary_bg_3} alt="bestiary" />
      </section>
      <section
      ...
      >
        <h1 className="text-secondary">Bestiário</h1>
