...
export default function Monster({ data }: Readonly<{ data: any }>) {
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 2xl:gap-32">
      <div className="justify-self-end self-start w-full text-gray-900">
      ...
      <div className="min-w-80 max-w-sm lg:max-w-md h-auto rounded-xl justify-self-center lg:justify-self-end self-start">
